...
// 一月热点文章
export const HOTMONTH = BASE_URL + '/hotpostthismonth'
// 全部热点文章
export const HOT = BASE_URL + '/hotpost'
// 更新文章浏览数
export const VIEW = BASE_URL + '/addpageview'
// 点赞
export const LIKE = BASE_URL + '/like'
// 是否已点赞
export const ISLIKE = BASE_URL + '/islike'
